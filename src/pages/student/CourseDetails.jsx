  ...
  return courseData ? (
    ...
    md:px-36 px-8 md:pt-30 pt-20 text-left"
      >
        ...
        -z-1 bg-gradient-to-b from-cyan-500/50"
        ></div>
        {/* left column */}
        ...
        text-course-details-heading-small font-semibold text-gray-800"
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">Courseflix</span>
          </p>
                  ...
                  >
                    ...
                    >
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className="flex items-start ap-2 py-1">
                          <img
                          ...
                          <div
                            className="flex items-center justify-between w-full text-gray-800 
                                       text-xs md:text-xs md:text-default"
                          >
            ...
            <div className="flex items-center gap-2">
             <img
              ...
              <p className="text-red-500">
                <span className="font-medium">S Days</span>left at this price
              </p>
            </div>
            ...
            <button className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600
             ...
             <div className="pt-6">
                ...
                <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500"> 
                    ...
                    <li> Quizzzez to test you knowledge</li>
